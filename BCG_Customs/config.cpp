...
class cfgWeapons {
	...
	class BCG_Helmet_Mavi: knd_helmet_punk {
		...
		hiddenSelectionsTextures[]={"BCG_Customs\data\Mavi\mavi1_co","BCG_Customs\data\Mavi\mavi2_co","BCG_Customs\data\Mavi\mavi3_co"};
	};
	class BCG_Helmet_Gryffin: tgf_helmets_warlord {
		...
		knd_hasLowLight=1;
		hiddenSelections[]={"camo1","camo2"};
		hiddenSelectionsTextures[]={"BCG_Customs\data\Gryffin\Warlord_Gryffin_Custom.paa","BCG_Armour\data\helmets\Warlord\camo2_co.paa"};
	};
	...
	class BCG_Helmet_Jacks: BCG_Helmet_Gunslinger {
		...
		subItems[]={};
		hiddenSelections[]={"camo1","camo2"};
		hiddenSelectionsTextures[]={"BCG_Customs\data\jacks\bcg_gunslinger_jacks_blk.paa","BCG_Armour\data\helmets\Gunslinger\camo2_co.paa"};
	};
	class BCG_Helmet_Yeetster: BCG_Helmet_Gunslinger {
		...
		hiddenSelections[]={"camo1","camo2"};
		hiddenSelectionsTextures[]={"BCG_Customs\data\tacobell\gunslinger.paa","BCG_Customs\data\tacobell\camo2_co.paa"};
		hiddenSelectionsMaterials[]={"BCG_Customs\data\tacobell\camo1.rvmat","BCG_Customs\data\tacobell\camo2.rvmat"};
	};
	class BCG_Helmet_Ace: tgf_helmets_executioner {
		...
		knd_hasLowLight=1;
		hiddenSelections[]={"camo1","camo2"};
		hiddenSelectionsTextures[]={"BCG_Customs\data\Ace\Ace.paa","BCG_Customs\data\Ace\Visor.paa"};
	};
...
class cfgVehicles {
	...
	class BCG_Plate_neifer: knd_Aranov_Solid_F {
		...
		hiddenSelections[]={"camo1","camo2"};
		hiddenSelectionsMaterials[]={"BCG_Customs\data\neifer\Armor\beskarshiny.rvmat","BCG_Customs\data\neifer\Armor\beskarshiny1.rvmat"};
		hiddenSelectionsTextures[]={"BCG_Customs\data\neifer\armor\camo1_co.paa","BCG_Customs\data\neifer\armor\camo2_co.paa"};
	};

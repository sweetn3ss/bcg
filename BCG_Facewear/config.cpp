...
class cfgGlasses {
	...
	class BCG_arbiter_belt: tgf_facewear_arbiter_belt {
		...
		hiddenSelectionsTextures[]={"BCG_Facewear\data\arbiter\camo1_co.paa"};
	};
	class BCG_forgemaster_belt: tgf_facewear_forgemaster_belt {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\forge\camo1_co.paa"};
	};
	class BCG_heavy_belt: tgf_facewear_heavy_belt {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\heavy\camo1_co.paa"};
	};
	class BCG_light_belt: tgf_facewear_light_belt {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\light\camo1_co.paa"};
	};
	class BCG_medium_belt: tgf_facewear_medium_belt {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\medium\whatthefuck.paa"};
	};
	class BCG_pilot_belt: tgf_facewear_pilot_belt {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\pilot\camo1_co.paa"};
	};
	class BCG_MedicKama: knd_kama {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\MedicKama\camo1_co.paa"};
	};
	class BCG_MaviKama: knd_kama {
		...
		hiddenSelections[]={"camo1"};
		hiddenSelectionsTextures[]={"BCG_Facewear\data\Customs\MaviKama.paa"};
	};
